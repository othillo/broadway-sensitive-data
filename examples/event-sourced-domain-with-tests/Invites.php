...
class InvitationCommandHandler extends Broadway\CommandHandling\CommandHandler
{
    ...
    public function __construct(
        ...
        \othillo\BroadwaySensitiveData\EventHandling\SensitiveDataManager $sensitiveDataManager
    ) {
    ...
    protected function handleInviteCommand(InviteCommand $command)
    {
        ...
        $this->sensitiveDataManager->setSensitiveData(new \othillo\BroadwaySensitiveData\EventHandling\SensitiveData(['name' => $command->name]));
