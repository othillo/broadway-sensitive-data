...
use othillo\BroadwaySensitiveData\EventHandling\SensitiveData;
use othillo\BroadwaySensitiveData\EventHandling\SensitiveDataManager;
use othillo\BroadwaySensitiveData\EventHandling\SensitiveDataProcessor;
...
class MySensitiveDataProcessor extends SensitiveDataProcessor
{
    ...
    protected function handleInvitedEvent(InvitedEvent $event, DomainMessage $domainMessage, SensitiveData $data = null)
    {
